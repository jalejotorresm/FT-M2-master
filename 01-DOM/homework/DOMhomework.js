...
span.innerHTML = span.innerHTML + "Alejandro Torres";
...
function addToDo() {
  ...
  if (value !== "") {
    ...
    alert('Por favor incluye un texto para añadir')
  }
}
...
// Tu código acá:
document.getElementById('addBotton').addEventListener('click', addToDo)
